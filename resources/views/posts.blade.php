                            ...
                            <div class='col-md-8'>
                                <div class='firma-card row'>
                                    <div class='col-md-5 img-padding-no'>
                                        <div class='firma-resim'><a href=localhost:8000/post/{$post[$x]['id']}/>{$post[$x]['id']}</a><a href='#'></a>
                                        </div>
                                    </div>
                                    <div class='col-md-7'>
                                        <div class='firma-aciklama card-body'>
                                            <ul class='yacht-info__list space-2'>
                                                <li>
                                                    ...
                                                    <span class'vertical-align-mid'>{$post[$x]['title']}</span>
                                                </li>
                                                <li>
                                                    <i class='search-boat-icon fa search-captain vertical-align-mid'></i>
                                                    <span class'vertical-align-mid'>{$post[$x]['caption']}</span>
                                                </li>
                                                <li>
                                                    <i class='search-boat-icon fa search-captain vertical-align-mid'></i>
                                                    <span class'vertical-align-mid'><a href='localhost:8000/category/{$post[$x]['category_id']}}/'>{$post[$x]['category'][0]['name']}</a></span>
                                                </li>
                                                <li>
                                                    <i class='search-boat-icon fa search-captain vertical-align-mid'></i>
                                                    <span class'vertical-align-mid'>".\Morilog\Jalali\Jalalian::forge($post[$x]['date'])."</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
